...
public class DatabaseConnection {
    ...
    private static final class ThreadLocalConnection extends ThreadLocal<Connection> {
        ...
        protected final Connection initialValue() {
            try {
                Class.forName(ServerProperties.getProperty("db.driver","org.postgresql.Driver")); // touch the mysql driver
            } catch (final Exception e) {
                System.err.println("没有找到需要的jdbc驱动，请确认把对应的jar拷贝过来了");
            }
            try {
                ...
                System.err.println("数据库服务没启动或配置文件对应的填写错误。");
                System.exit(0);
                return null;
            }
        }
