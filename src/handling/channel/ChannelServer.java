...
public class ChannelServer {
    ...
    public final void run_startup_configurations() {
        ...
        //final NioSocketAcceptorConfig acceptor_config = new NioSocketAcceptorConfig();
        ...
        try {
            ...
            acceptor.bind(new InetSocketAddress(ServerConstants.IP,port) );
            System.out.println("频道 " + channel + " 在端口 " + port + " 开始工作");
            eventSM.init();
        } catch (IOException e) {
            System.out.println("绑定端口 " + port + " 失败 (频道: " + getChannel() + ")");
            System.exit(0);
    ...
    public final List<MapleCharacter> getPartyMembers(final MapleCharacter party) {
	List<MapleCharacter> chars = new LinkedList<MapleCharacter>();
	for (final MaplePartyCharacter partychar : getPlayer().getParty().getMembers()) {
