...
public class LoginInformationProvider {
    ...
    public enum JobType {
        ...
        UltimateAdventurer(-1, "Ultimate", 0, 130000000),//终极冒险家
        Resistance(0, "Resistance", 3000, 931000000),//反抗者
        Adventurer(1, "", 0, 10000),   //冒险家
        Cygnus(2, "Premium", 1000, 913040000),//骑士团
        Aran(3, "Orient", 2000, 914000000), //战神
        Evan(4, "Evan", 2001, 900090000),//龙神
        Mercedes(5, "", 2002, 910150000),//双弩精灵
        Demon(6, "", 3001, 931050310),//恶魔猎手
        Phantom(7, "", 2003, 10000/*915000000*/),//2003幻影
        DualBlade(8, "", 0, 103050900),  //龙的传人
        Mihile(9, "", 5000, 913070000),  //国服未出现
        Jett(10, "", 508, 10000),
        Luminous(11, "", 2004, 10000), //    subject to change in the
        Kaiser(12, "", 6000, 10000),   //       order of numbers
